...
/**
 * [pwc_apply_currency_postion Get product price and append currency symbol ]
 * @param  [string] $price
 * @param  [string] $cur  
 * @return [string]
 */

if( ! function_exists( 'pwc_apply_currency_postion' ) ) {

	function pwc_apply_currency_postion( $price, $cur = '$' ) {
