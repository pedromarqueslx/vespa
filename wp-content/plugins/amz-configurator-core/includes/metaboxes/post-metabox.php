<?php
	...
	$menu_list = array();
	$menu_list[] = esc_html__( 'Default', 'amz-configurator-core' );
	...
	$post_metabox = array(
		'metabox'	=> array( 
			'id'         => 'post',
			'title'      => esc_html__( 'Post Options', 'amz-configurator-core' ),
			'post_type'  => 'post',
			'context'    => 'normal',
			'priority'   => 'low',
			'tabs' 		 => true,
		...
		'fields'     => array(
			...
			array(
				...
				'options'	   => array(
					...
					'header3' => 'header-layout/header3.png',
					'header4' => 'header-layout/header4.png'
				),
				'type' 		   => 'image_select',
				'class' => 'header', // class name for this meta field
			),
	...
	$post_metabox = new Amazee_Metabox( $post_metabox );