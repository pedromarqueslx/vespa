...
<div id="product-<?php the_ID(); ?>" <?php post_class( 'single-product-wrap section-konfigurator' ); ?>>
	...
	<div class="row-container">
		...
		<div class="row row-parent col-std-gutter double-top-padding double-bottom-padding limit-width">
			...
			<div class="row-inner">
				...
				<div class="single-product-content clearfix" style="padding:10px 30px 0 30px">
