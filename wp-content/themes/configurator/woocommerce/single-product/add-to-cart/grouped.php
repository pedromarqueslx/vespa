...
$overlap = configurator_get_option_value( 'single_product_cart_btn_overlap', 'overlap' ); ?>

<div class="config-cart-form">
	<form class="cart grouped_form <?php echo esc_attr( $overlap ); ?>" action="<?php echo esc_url( apply_filters( 'woocommerce_add_to_cart_form_action', $product->get_permalink() ) ); ?>" method="post" enctype='multipart/form-data'>
